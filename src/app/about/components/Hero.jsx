  ...
  return (
    <div className="px-4 py-28 font-gs mx-auto  bg-light text-first  md:px-24 lg:px-8 lg:py-40">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
          <p className="inline-block px-3 py-px mb-4 text-xs   text-lg md:text-xl lg:text-2xl  font-bold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
            Brand new
          </p>
        </div>
